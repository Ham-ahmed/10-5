...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing gosatplus--oscam_11959-r802 #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/10-5/refs/heads/main/enigma2-plugin-softcams-gosatplus-oscam_11959-emu-r802_all.ipk"
IPK_NAME="enigma2-plugin-softcams-gosatplus-oscam_11959-emu-r802_all.ipk"
