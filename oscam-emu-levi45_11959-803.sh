...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing oscam-emu-levi45_11959-803  #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/10-5/refs/heads/main/enigma2-plugin-softcams-oscam-emu-levi45_11959-803_all.ipk"
IPK_NAME="enigma2-plugin-softcams-oscam-emu-levi45_11959-803_all.ipk"
